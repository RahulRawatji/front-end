...
const meunItems = document.querySelectorAll('.menu-item');
...
meunItems.forEach((item)=>{
    ...
    const mouseOverAnimation = elm =>{
        gsap.to(elm.querySelectorAll('p:nth-child(1)'),{
            top:'-100%',
            duration: 0.3
        });
        gsap.to(elm.querySelectorAll('p:nth-child(2)'),{
            top:'0%',
            duration: 0.3
        })
    }

    const mouseOutAnimation = elm =>{
        gsap.to(elm.querySelectorAll('p:nth-child(1)'),{
            top:'0%',
            duration: 0.3
        });
